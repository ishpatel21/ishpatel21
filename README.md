...
- **[Resume Job Tailor](https://github.com/ishpatel21/Resume-Job-Tailor)** → Chat with your PDFs. Get instant answers with citations. (Python)  
...
- **[react-photogallery](https://github.com/ishpatel21/react-photogallery)** → Clean, immersive React photo gallery with slick slideshow  
- **[dropbox-spring-boot](https://github.com/ishpatel21/dropbox-spring-boot)** → Full Dropbox file manager (upload/download/delete) in Spring Boot  
- **[school-projects](https://github.com/ishpatel21/school-projects)** → Massive collection: ASP.NET, Assembly, C++, Java, Unity, HTML — the roots of my versatility
